...
if st.session_state.step == 1:
    ...
    st.divider()
    st.warning(chr(10).join(['ACTION REQUIRED','','1. Copy CST External Orders above to the CST Task Sheet (Uncovered tab).','2. Copy Non-CST External Orders above to the AF Scheduling Daily Task Workbook (Uncovered tab).','','Click Done below once you have completed this step.']))
    c1,c2 = st.columns(2)
    with c1:
